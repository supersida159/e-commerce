...
type CreateOrderStore interface {
	CreateOrder(ctx context.Context, data *order_request.CreateOrderRequest) error
	OrderCancelled(ctx context.Context, Id string) error
}
...
func (biz *createOrderBiz) CreateOrderBiz(ctx context.Context, data *order_request.CreateOrderRequest) error {
